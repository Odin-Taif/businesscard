        ...
        <Layout {...siteConfig}>
          ...
          <Container className="!pt-0">
            <div className="max-w-screen-md mx-auto ">
              ...
              <h1 className="flex justify-left mt-2 mb-3 text-3xl font-semibold tracking-tight text-center lg:leading-snug text-brand-primary lg:text-4xl dark:text-white">
                {post.title}
              </h1>
